...
function Header() {
  ...
  return (
    <header className="header text-center">	    
        ...
        <Navbar className="navbar navbar-expand-lg navbar-dark" expand="lg" expanded={expanded}>
            <Navbar.Toggle onClick={() => setExpanded(expanded ? false : "expanded")} aria-controls="navigation" />
            ...
            <Navbar.Collapse id="navigation" className="flex-column">
                <div className="profile-section pt-3 pt-lg-0">
                    ...
                    <div className="bio mb-3">Hi, my name is Dang Khoa. Briefly introduce yourself here. You can also provide a link to the about page.
                        <br/>
                        <NavLink exact to="/about" onClick={() => setExpanded(false)}>Find out more about me</NavLink>
                    </div>
                ...
                <Nav className="flex-column text-left">
                    <li className="nav-item">
                        <NavLink exact to="/" className="nav-link" onClick={() => setExpanded(false)}>
                            <i className="fas fa-home fa-fw mr-2"></i> Blog Home 
                            <span className="sr-only">(current)</span>
                        </NavLink>
                    </li>
                    <li className="nav-item">
                        <NavLink exact to="/blogs" className="nav-link" onClick={() => setExpanded(false)}>
                            <i className="fas fa-bookmark fa-fw mr-2"></i> Posts Server Repl
                        </NavLink>
                    </li>
                    <li className="nav-item">
                        <NavLink exact to="/blogs_graphcms" className="nav-link" onClick={() => setExpanded(false)}>
                            <i className="fas fa-bookmark fa-fw mr-2"></i> Posts Server GraphCMS
                        </NavLink>
                    </li>
                    <li className="nav-item">
                        <NavLink exact to="/about" className="nav-link" onClick={() => setExpanded(false)}>
